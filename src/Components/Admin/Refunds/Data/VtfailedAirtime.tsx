...
export const VtFailedAirtime: React.FC = () => {
    ...
    return (
        <Box>
            <Heading textAlign={"center"} fontSize={"1.1rem"} mb={"1rem"}>failed Vtpass Airtime transactions</Heading>
            {
                fetchState.loading && (
                    <Center>
                        <Spinner/>
