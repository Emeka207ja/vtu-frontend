...
export const Footer: React.FC = () => {
    ...
    return (
        <Box w={"100%"} bg={colorMode === "light" ? "blackAlpha.200" : "whiteAlpha.100"} position={"fixed"} bottom={0} left={0} padding={"1rem"} boxShadow={colorMode=== "light"?"0 -2px 4px black":"0 -2px 4px white"}>
