            ...
            <Grid templateColumns={{base:"repeat(1fr)", md:"repeat(2, 1fr)"}} justifyItems={"center"} gap={"1rem"} display={{base:"grid",md:"flex"}}>
                ...
                <GridItem>
                    <Box>
                        ...
                        <Text textAlign={"center"}  fontSize={"1rem"}>AllPoint  is a web platform where users can purchase Mobile Data Bundles, VTU Airtime, Pay Electricity Bills, TV Subscription..</Text>
