...
export const TC: React.FC = () => {
    return(
        <Container>
            ...
            <Center mb={"1rem"}>
               The User acknowledges that this Policy is a part of Aillpoints Terms & Conditions and all the terms defined there have the same meaning here in this Policy. Access, browsing and continuous use of the Website constitutes the Users unconditional consent to this Policy read together with the Terms of Use. If the User does not agree with the terms of this Policy, please do not visit and use our Website. This Policy can be easily accessed at various places on our Website, including but not limited to when Users create an account with us on our Website.
            </Center>

            <Center mb={"1rem"}>
              Allpoint reserves its right to modify, alter, and update this Policy at any time, with or without prior notice. Although, Users shall be notified of material changes through their registered email address or any other mode of communication available with us, it is advised that they consult this Policy regularly to be updated about the changes. If a User continues to use or avail the services of the Website after any modification, amendment, alteration or change of this Policy, irrespective of whether notice was sent to the User or published on the Website, such User is hereby deemed to provide consent to this Policy and Allpoints other Policies and practices existing at the time of visiting, accessing and/or using the Website.
            </Center>
            ...
            <Center mb={"1rem"}>
                ...
                <OrderedList>
                    <ListItem>Section 43A of the Information Technology Act, 2000 (“Act”)</ListItem>
                    <ListItem>Regulation 4 of the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Information) Rules, 2011 SPI Rules</ListItem>
                </OrderedList>
            </Center>
            ...
            <Center mb={"1rem"}>
               1. passwords;
                ...
                4. Information which is freely available in the public domain or furnished under the Right to Information Act, 2005 or any other law shall not be regarded as sensitive personal data or information.PAYMENT DATA
            </Center>
            ...
            <Center mb={"1rem"}>
              Allpoint presumes adequate and lawful parental consent in case the Personal Information or Sensitive personal data or information is shared by a User under the age of 18 years.
            ...
            <Center mb={"1rem"}>
              1.    full name and age;
                ...
                4.    password of Users account registered with us;
                ...
                11. Users feedback, queries, e-mails, letters, suggestions provided to us;

                12. third party information about concerned Users activities or postings on the Website;
            ...
            <Center mb={"1rem"}>
               PURPOSE OF COLLECTION
                ...
                11. other such lawful purposes as described at the time of collection of Personal Information or
            ...
            <Center mb={"1rem"}>
                ...
                To improve the effectiveness and usability of the Website for our Users, we use cookies, or similar technology to collect information and assign each visitor a unique random number called as a User Identification User ID in order to understand the Users individual interests. Our web servers automatically collect limited information about the Users computer connection to the Internet, including Uses IP address, when the User visits the Website Users IP address is a number that lets computers connected to the internet know where to send data to the User such as the web pages viewed by the User.
            ...
            <Center mb={"1rem"}>
                  MAIL
                Allpoint may send direct mail to the User at the email address given by the User. The User has the option to opt-out of this direct mailer by way of links provided at the bottom of each mailer or any other means as Allpoint deems appropriate. Allpoint respects every Users privacy and in the event that User chooses to not receive such mailers, Allpoint will take all steps to remove the User from the list. If a User wants to remove his/her/its contact information from all mailing lists and newsletters, the same can be done through “Profile” page of his/her/its account with Allpoint.
             ...
             <Center  mb={"1rem"}>
                ...
                If you seek any clarifications regarding this Policy or wish to raise any issue or grievance with respect to illegal access, use or disclosure of Personal Information, please e-mail at  help@Allpoint.ng
